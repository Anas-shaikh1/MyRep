...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        productList = listOf(
            Product(1, "Tshirt", 49.99, "Clothing", listOf("image1.jpg", "image2.jpg")),
            Product(2, "Laptop", 699.99, "Electronics", listOf("image1.jpg", "image2.jpg")),
            Product(3, "Sofa", 499.99, "Home", listOf("image1.jpg", "image2.jpg")),
            Product(4, "Jeans", 1299.99, "Clothing", listOf("image1.jpg"))
        )
